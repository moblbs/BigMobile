                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="dataTable_wrapper">
                                <table class="table table-striped table-bordered table-hover" id="insuranceUserTables">
                                    <thead>
                                        <tr>
                                            <th>手机号码</th>
                                            <th>公司</th>
                                    ...
                                    <tbody>
	                                    <c:forEach items="${insuranceUserList}" var="insuranceUser">
										   	<tr>
											   	<td>${insuranceUser.mobile}</td>
										   		<td>${insuranceUser.enterprise}</td>
											   	<td>${insuranceUser.enterprise_english}</td>
											   	<td>${insuranceUser.department}</td>
											   	<td>${insuranceUser.department_english}</td>
											   	<td>${insuranceUser.position}</td>
											   	<td>${insuranceUser.position_english}</td>
											   	<td>${insuranceUser.name}</td>
											   	<td>${insuranceUser.gender}</td>
											   	<td>${insuranceUser.address}</td>
											   	<td>${insuranceUser.telephone}</td>
											   	<td>${insuranceUser.email}</td>
											   	<td>${insuranceUser.industry}</td>
										   	</tr>
									    </c:forEach>                                       
                                    </tbody>
                                </table>
