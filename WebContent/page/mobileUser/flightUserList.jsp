                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="dataTable_wrapper">
                                <table class="table table-striped table-bordered table-hover" id="flightUserTables">
                                    <thead>
                                        <tr>
                                            <th>姓名</th>
                                            <th>手机号码</th>
                                    ...
                                    <tbody>
	                                    <c:forEach items="${flightUserList}" var="flightUser">
										   	<tr>
										   		<td>${flightUser.name}</td>
											   	<td>${flightUser.mobile}</td>
											   	<td>${flightUser.address}</td>
											   	<td>${flightUser.postcode}</td>
											   	<td>${flightUser.from_city}</td>
											   	<td>${flightUser.to_city}</td>
											   	<td>${flightUser.seat}</td>
										   	</tr>
									    </c:forEach>                                       
                                    </tbody>
                                </table>
