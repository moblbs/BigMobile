                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="dataTable_wrapper">
                                <table class="table table-striped table-bordered table-hover" id="socialSecurityUserTables">
                                    <thead>
                                        <tr>
                                            <th>手机号码</th>
                                            <th>姓名</th>
                                    ...
                                    <tbody>
	                                    <c:forEach items="${socialSecurityUserList}" var="socialSecurityUser">
										   	<tr>
											   	<td>${socialSecurityUser.mobile}</td>
										   		<td>${socialSecurityUser.name}</td>
											   	<td>${socialSecurityUser.address}</td>
											   	<td>${socialSecurityUser.postcode}</td>
											   	<td>${socialSecurityUser.education}</td>
											   	<td>${socialSecurityUser.basicFee}</td>
											   	<td>${socialSecurityUser.gender}</td>
											   	<td>${socialSecurityUser.birthyear}</td>
										   	</tr>
									    </c:forEach>                                       
                                    </tbody>
                                </table>
...
<script>
    $(document).ready(function() {
        $('#socialSecurityUserTables').DataTable({
              responsive: true
        });
    });
</script>
