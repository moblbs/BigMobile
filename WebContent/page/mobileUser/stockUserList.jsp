                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="dataTable_wrapper">
                                <table class="table table-striped table-bordered table-hover" id="stockUserTables">
                                    <thead>
                                        <tr>
                                            <th>手机号码</th>
                                            <th>姓名</th>
                                    ...
                                    <tbody>
	                                    <c:forEach items="${stockUserList}" var="stockUser">
										   	<tr>
											   	<td>${stockUser.mobile}</td>
										   		<td>${stockUser.name}</td>
											   	<td>${stockUser.capital}</td>
											   	<td>${stockUser.telephone}</td>
											   	<td>${stockUser.area}</td>
										   	</tr>
									    </c:forEach>                                       
                                    </tbody>
                                </table>
