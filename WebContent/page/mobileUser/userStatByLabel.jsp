...
<body>
    ...
    $(function() {
        ...
        var plotObj = $.plot($("#flot-pie-chart"), ${UserStatByLabelCar}, {
            series: {
                pie: {
                    show: true
                }
        ...
        var plotObj = $.plot($("#flot-pie-chart2"), ${UserStatByLabelFinance}, {
            series: {
                pie: {
                    show: true
                }
        ...
        var plotObj = $.plot($("#flot-pie-chart3"), ${UserStatByLabelHealthcare}, {
            series: {
                pie: {
                    show: true
                }
    	...
    	Morris.Donut({
            ...
            data:${UserStatByLabelEducation},
            resize: true
        });
    	
    	Morris.Donut({
            element: 'morris-donut-chart2',
            data:${UserStatByLabelRealestate},
            resize: true
        });
    	
    	Morris.Donut({
            element: 'morris-donut-chart3',
            data:${UserStatByLabelBrand},
            resize: true
        });
    });
