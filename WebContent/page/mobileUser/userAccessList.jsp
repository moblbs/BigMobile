                        ...
                        <div class="panel-body">
                            <div class="dataTable_wrapper">
                                <table class="table table-striped table-bordered table-hover" id="mobileUserTables">
                                    ...
                                    <tbody>
	                                    <c:forEach items="${userAccessList}" var="userAccess">
										   	<tr>
											   	<td>${userAccess.mobile}</td>
										   		<td>${userAccess.site}</td>
											   	<td>${userAccess.ip}</td>
											   	<td>${userAccess.website}</td>
											   	<td>${userAccess.accesstime}</td>
											   	<td>${userAccess.weburl}</td>
											   	<td>${userAccess.targetip}</td>
											   	<td>${userAccess.serviceport}</td>
											   	<td>${userAccess.websitetype}</td>
										   	</tr>
									    </c:forEach>                                       
                                    </tbody>
                                </table>
